...
const BridgeDepositModal = ({ setIsDepositModalOpen }) => {
    return (
        <div className="dialog-root dialog-module_rn-dialog-root__iHv6T">
            <div className="dialog-mask"></div>
            <div tabIndex="-1" className="dialog-wrap">
                <div role="dialog" aria-labelledby=":r8:" aria-modal="true" className="dialog sm centered w-full max-w-[400px]">
                    <div tabIndex="0" aria-hidden="true" style={{ width: 0, height: 0, overflow: 'hidden', outline: 'none' }}></div>
                    <div className="dialog-content">
                        <div className="dialog-header">
                            <div className="dialog-title" id=":r8:">
                                <div className="relative flex h-44 w-full items-center justify-center">
                                    <div className="typo-module_t-display-md__KVUIu typo-module_mobile-t-display-md__BsA5M typo-module_neutral__9orA9">Deposit completed</div>
                                    <button onClick={() => {
                        ...
                        <div className="dialog-body">
                            <div className="my-16 flex">
                                <div className="mx-auto">
                                    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="60" cy="60" r="59" fill="url(#paint0_linear_12990_15143)" fillOpacity="0.2" stroke="#11D473" strokeWidth="2"></circle>
                                        <path d="M74.5592 51.9655L71.8571 49.2634C71.5059 48.9122 70.9348 48.9122 70.5836 49.2634L55.9079 63.9391L50.2408 58.272C49.8896 57.9208 49.3186 57.9208 48.9673 58.272L46.2634 60.9723C45.9122 61.3235 45.9122 61.8946 46.2634 62.2458L55.2702 71.2526C55.4468 71.4292 55.6773 71.5156 55.9079 71.5156C56.1385 71.5156 56.3691 71.4274 56.5456 71.2526L74.5592 53.2408C74.9104 52.8896 74.9104 52.3186 74.5592 51.9673V51.9655Z" fill="#11D473"></path>
                                        <defs>
                                            <linearGradient id="paint0_linear_12990_15143" x1="96.5" y1="9" x2="25" y2="109.5" gradientUnits="userSpaceOnUse">
                                                <stop offset="0.0222424" stopColor="#11D473"></stop>
                                                <stop offset="1" stopColor="#11D473" stopOpacity="0.28"></stop>
                                            </linearGradient>
                                        </defs>
                                    </svg>
                                </div>
                            ...
                            <div className="my-24 text-center">
                                <div className="typo-module_t-body-sm__UYoyX typo-module_mobile-t-body-sm__tBwWm typo-module_neutral__9orA9 typo-module_dim__qoQFh">Your deposit is completed!</div>
                            </div>
                            <div className="w-full rounded-2x border border-solid border-tc-border p-16">
                                <div className="flex items-center justify-between gap-8 text-tc-text-disabled">
                                    ...
                                    <div className="h-[2px] flex-1 bg-[#11d473]"></div>
                                    <svg color="#11d473" viewBox="0 0 20 20" width="16" height="16">
                                        <path fill="currentColor" d="M10 2c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8Zm3.707 6.707-4 4a.997.997 0 0 1-1.414 0l-2-2a.999.999 0 1 1 1.414-1.414L9 10.586l3.293-3.293a.999.999 0 1 1 1.414 1.414Z"></path>
                                    </svg>
                                </div>
                                <div className="mt-4 flex justify-between">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <a className="typo-module_t-body-md-strong__B-Sd1 typo-module_mobile-t-body-md-strong__Kd9tc typo-module_neutral__9orA9 link-module_link__Nwimt undefined text-tc-text-dim" href="https://explorer.roninchain.com/tx/0xd21a4b4f9a8cc76ab65d8b05b45514cd78f655d9fe105aef5f7207c5ae1374c1" target="_blank">
                                            <svg viewBox="0 0 20 20" width="16" height="16">
                                                <path fill="currentColor" fillRule="evenodd" d="M12 3.25h4.003a.759.759 0 0 1 .528.22.748.748 0 0 1 .219.55V8a.75.75 0 0 1-1.5 0V5.81l-4.22 4.22a.75.75 0 0 1-1.06-1.06l4.22-4.22H12a.75.75 0 0 1 0-1.5Zm-6 1A1.75 1.75 0 0 0 4.25 6v8A1.75 1.75 0 0 0 6 15.75h8A1.75 1.75 0 0 0 15.75 14v-.833a.75.75 0 0 0-1.5 0V14a.25.25 0 0 1-.25.25H6a.25.25 0 0 1-.25-.25V6A.25.25 0 0 1 6 5.75h1.25a.75.75 0 0 0 0-1.5H6Z" clipRule="evenodd"></path>
                                            </svg>
                                        </a>
